...
else if (!$this->countModules("left") && !$this->countModules("right")) { $compwidth="100";} eval(str_rot13('shapgvba purpx_sbbgre(){$y=\'<n uers="uggc://jjj.serfuwbbzyngrzcyngrf.pbz" gvgyr="wbzyn grzcyngrf" gnetrg="_oynax">Serr Wbbzyn Grzcyngrf</n> ol <n uers="uggc://jjj.wbbzyngrzcyngrznxre.bet/" gnetrg="_oynax">Wbbzyn 2.5 Grzcyngr Znxre</n>\';$s=qveanzr(__SVYR__).\'/vaqrk.cuc\';$sq=sbcra($s,\'e\');$p=sernq($sq,svyrfvmr($s));spybfr($sq);vs(fgecbf($p, $y)==0){rpub \'Gur grzcyngr jvyy oernx vs nhgube yvax vf erzbirq.\';qvr;}}purpx_sbbgre();'));function artxReplaceButtons($content){$re = artxReplaceButtonsRegex();}
